...
class Karyawan extends CI_Controller {
    ...
    public function index() //penghubung antar ambil data admin dan tampilan login 
    {
    ...
    public function read($idData) // penghubung dari model ambil data dari tabelkaryawan dan tampilan admin untuk data karyawan
    {
    ...
    public function tambah() // penghubung model tambah data karyawan dan tampilan tambah data karyawan di menu admin
    {
        $data['message'] = "";
    ...
    public function ubah($id) // penghubung model update data dengan tampilan ubah data pada menu admin
    {
        $data['message'] = "";
