 <!-- command header untuk tampilan utama -->
<?php
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="phone">08570672816</div>
						<div class="social">
							<ul class="social_list">
								<li class="social_list_item"><a href="https://www.facebook.com/pg/MachineCareServices/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li class="social_list_item"><a href="https://twitter.com/damnitsryannn"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							</ul>
						</div>
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="images/logo.png" alt="">Machine Care</a></div>
						</div>
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="<?php echo base_url('pricing') ?>">Harga</a></li>
